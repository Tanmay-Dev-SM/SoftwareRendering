...
void update(void) {
	...
	for (int i = 0; i < num_faces; i++) {
		...
		vec2_t projected_points[3];//--For Fixed Cube
		...
		triangle_t projected_triangle_fixed = {
			.points = {
		...
		array_push(triangles_to_render, projected_triangle_fixed);//--change the projected_triangle to projected_triangle_fixed
	}
